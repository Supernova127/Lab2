...
int main(){	
	...
	try
	{
		...
		while (true) {
			...
			std::cout << 
				"Нажмите 1 чтобы выполнить проверку с заданной сложностью\n"
				"Нажмите 2 чтобы выполнить проверку с преимуществом с заданной сложностью\n"
				"Нажмите 3 чтобы выполнить проверку с помехой с заданной сложностью\n"
